...
*/
    ...
    player createDiaryRecord ["credits",
        [
            "Developers",
                "
Custom map and custom scripts created by Glaedar of New Arma Life. Original framework created by Tonic and updated by the AsYetUntitled community.<br/><br/>
Systems such as the faction system, leveling system were created by Glaedar, with guidance along the way from members of AsYetUntitled development community.<br/><br/>
Special thanks to (in no particular order):<br/><br/>
Sgt. Cuddles, for his ongoing support within the ARMA Life community, and the personal support he has provided me throughout the development stage.<br/>
KLM, for his help with helping me realise my ethics pertaining to original code and such. Without the long discussion we had, I wouldn't have learnt as much as I have to this day. <br/>
Bailey, for helping me with scripting and being an all-around sick cunt. <br/>
Wackbatt, for helping me along the way by helping me within the support channels of the Discord. <br/>
Jawsh, for helping me with scripts and being one of the only other Australian people on the entire Discord. <br/>
Basti | John Collins, who's never afraid to answer perhaps the most retarded questions asked by me and other people in the Discord. <br/>
Boguu, for once again answering questions about the framework and being one of the lead GitHub moderators.
                "
        ]
    ];
    ...
    player createDiaryRecord ["changelog",
        [
            "New Malden Life Changelog",
                "
The full changelog, development diary and roadmap can be found on our website [ malden.newarma.life ] <br/><br/>
Version 1.0 <br/>
By: Glaedar <br/>
                "
        ]
...
*/
        ...
        [
            "Exploits",
                "
Global New Arma Gaming rules can be found at [ https://newarma.life/rules ] <br/><br/>

These are considered exploits that will lead to a profile reset or a permenant ban.<br/><br/>
...
*/
    ...
    player createDiaryRecord ["serverrules",
        [
            "Bannable Offenses",
                "
These offences can directly lead to a ban.<br/><br/>
1. Hacking<br/>
2. Cheating<br/>
