...
/* System Settings */
	...
	//////////////////////////////
	/* Taxi Configurations */
	markerArray[] = {"t_mark_1","t_mark_2","t_mark_3","t_mark_4","t_mark_5","t_mark_6","t_mark_7","t_mark_8","t_mark_9","t_mark_10"};
	taxiArray[] = {"7285.12,8017.34","7033.36,7121.48","8244.99,3141.4","9659.66,3341.04","5909.76,3603.36","5353.25,2734.99","3116.74,6286.78","5545.37,6998.3","8265.21,10043.7","5557.69,11193.7"};
    ...
    fuel_cost = 125; //Cost of fuel per liter at fuel stations (if not defined for the vehicle already).
    ...
    bank_cop = 20000000; //Amount of cash in bank for new cops
    bank_civ = 20000000; //Amount of cash in bank for new civillians
    bank_med = 20000000; //Amount of cash in bank for new medics
	  bank_opfor = 200000; //Added 14/08/2017

    paycheck_cop = 1500; //Payment for cops
    paycheck_civ = 1000; //Payment for civillians
    paycheck_med = 2000; //Payment for medics
    paycheck_opfor = 2000; //Added 14/08
    ...
    delivery_points[] = { "dp_1", "dp_2", "dp_3", "dp_4", "dp_5" }; //, "dp_6", "dp_7", "dp_8", "dp_9", "dp_10", "dp_11", "dp_12", "dp_13", "dp_14", "dp_15", "dp_15", "dp_16", "dp_17", "dp_18", "dp_19", "dp_20", "dp_21", "dp_22", "dp_23", "dp_24", "dp_25" };
	  delivery_points_illegal[] = { "idp_1", "idp_2", "idp_3", "idp_4", "idp_5", "idp_6" };
    fuelTank_winMultiplier = 1.3; //Win Multiplier in FuelTank Missions. Increase for greater payout. Default = 1
