...
class VirtualShops {
    //Virtual Shops
	class swat_market {
		name = "STR_Shops_M_Opfor";
		side = "cop";
		conditions = "call life_swatlevel >= 1";
		items[] = { "waterBottle", "tbacon", "toolkit", "fuelFull" };
	};
	
	class swat_market_2 {
		name = "STR_Shops_M_OpforSpecial";
		side = "cop";
		conditions = "call life_swatlevel >= 1";
		items[] = { "boltcutter", "blastingcharge", "defibrillator" };
	};
	...
	class opfor_market {
		name = "STR_Shops_M_Opfor";
		side = "";
		conditions = "call life_opforlevel >= 1";
		items[] = { "waterBottle", "tbacon", "toolkit", "fuelFull" };
	};
	
	class opfor_market_2 {
		name = "STR_Shops_M_OpforSpecial";
		side = "";
		conditions = "call life_opforlevel >= 3";
		items[] = { "boltcutter", "blastingcharge", "defibrillator" };
	};
	...
	class sec {
		name = "Security Item Shop";
		side = "cop";
		conditions = "call life_coplevel = 10";
		items[] = { "waterBottle", "redgull", "donuts", "tbacon", "toolkit", "fuelFull", "defibrillator" };
	};
};
...
class VirtualItems {
    ...
    class oil_unprocessed {
        ...
        displayName = "Barley";
        weight = 4; //orig weight 7
        buyPrice = -1;
        sellPrice = -1;
        illegal = false;
        edible = -1;
        icon = "icons\ico_oilUnprocessed.paa"; //new icon needed
    };
    ...
    class oil_processed {
        ...
        illegal = false;
        edible = -1;
        icon = "icons\ico_oilProcessed.paa"; //new icon needed
    };
    ...
    class copper_unrefined {
        ...
        illegal = false;
        edible = -1;
        icon = "icons\ico_copperOre.paa"; //new icon needed
    };
    ...
    class copper_refined {
        ...
        illegal = false;
        edible = -1;
        icon = "icons\ico_copper.paa"; //new icon needed
    };
    ...
    class iron_unrefined {
        ...
        illegal = false;
        edible = -1;
        icon = "icons\ico_ironOre.paa"; //new icon needed
    };
    ...
    class iron_refined {
        ...
        illegal = false;
        edible = -1;
        icon = "icons\ico_iron.paa"; //new icon needed
    };

    class salt_unrefined {
        variable = "saltUnrefined";
        displayName = "Raw Coffee";
        weight = 5; //orig 3
        buyPrice = -1;
        sellPrice = -1;
        illegal = false;
        edible = -1;
        icon = "icons\ico_saltUnprocessed.paa"; //new icon needed
    };
    ...
    class salt_refined {
        ...
        illegal = false;
        edible = -1;
        icon = "icons\ico_saltProcessed.paa"; //new icon needed
    };
    ...
    class sand {
        ...
        illegal = false;
        edible = -1;
        icon = "icons\ico_sand.paa"; //new icon needed
    };
    ...
    class glass {
        ...
        illegal = false;
        edible = -1;
        icon = "icons\ico_glass.paa"; //new icon needed
    };
