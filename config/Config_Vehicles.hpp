class CarShops {
    ...
    */
	...
	class opfor_car	{
		side = "opfor";
		conditions = "call life_opforlevel >= 2";
		vehicles[] = {
			{ "O_Quadbike_01_F", "" },
			{ "O_G_Offroad_01_F", "" },
			{ "O_Truck_03_covered_F", "call life_opforlevel >=3" },
			{ "O_T_LSV_02_unarmed_black_F", "call life_opforlevel >=3" },
			{ "O_G_Offroad_01_armed_F", "call life_opforlevel >=3" },
			{ "O_MRAP_02_F", "call life_opforlevel >=3" },
			{ "O_MRAP_02_hmg_F", "call life_opforlevel >=4"},
			{ "O_T_APC_Tracked_02_AA_ghex_F", "call life_opfor == 10" }
		};
	};
	
	class opfor_air {
		side = "opfor";
		conditions = "call life_opforlevel >= 3 || licence_opfor_oSpecial";
		vehicles[] = {
			{ "B_Heli_Light_01_F", "" },
			{ "O_Heli_Light_02_unarmed_F", "" },
			{ "O_Heli_Transport_04_F", ""},
			{ "O_UAV_02_dynamicLoadout_F", "call life_opforlevel >=5" },
			{ "O_Heli_Light_02_F", "call life_opforlevel >=5" }
		//	{ "O_UAV_01_F", "call life_opforlevel >=5" }
		};
	};
	
	class opfor_jet {
		side = "opfor";
		conditions = "call life_opforlevel >=5";
		vehicles[] = {
			{ "O_UAV_02_CAS_F", "" },
			{ "O_Plane_Fighter_02_F", "" },
			{ "O_Plane_CAS_02_dynamicLoadout_F", "" },
			{ "O_T_VTOL_02_infantry_F", "call life_opforlevel >=4" },
			{ "O_T_VTOL_02_vehicle_F", "call life_opforlevel >=4" }
		};
	};
	...
	class opfor_ship {
		side = "opfor";
		conditons = "call life_opforlevel >=3 || licence_opfor_oSpecial";
		vehicles[] = {
			{ "O_Boat_Transport_01_F", "" },
			{ "O_SDV_01_F", "" },
			{ "O_Boat_Armed_01_hmg_F", "call life_opforlevel >= 4" }
		};
	};
	//end of added shit
