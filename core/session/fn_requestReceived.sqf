...
diag_log "::New Arma:: Information received from `players` table";
...
switch (playerSide) do {
    ...
    case independent: {
  	...
  	case east: {  //added 16/08
        // Base Framework
    		CONST(life_opforlevel,(_this select 7));
    		CONST(life_coplevel,0);
...
// Runs the data query again, this time setting up player stats
