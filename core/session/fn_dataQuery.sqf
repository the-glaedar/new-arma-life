...
if (life_session_completed) exitWith {[_uid,_side,_sender] remoteExec ["DB_fnc_queryRequestStats",RSERV];}; //Why did this get executed when the client already initialized? Fucking arma...
