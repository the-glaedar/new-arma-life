...
*****************************
*/
// Variables for Bank Robbery Framework
life_robbery_in_progress = false;

// Variables for Taxi Framework
life_taxi_in_progress = false;
life_delivery_in_progress_illegal = false;

// Variable for Illegal Delivery Framework
life_gangDP_in_progress = false;

// Variables for new illegal delivery
life_dynamicDP = false;
life_dynamicDPContainers = false;

// Variables for Legal Delivery Framework
life_dp_in_progress = false;

// Variable for server weather module
life_automatic_weather = true;
...
life_taxi_temp = -1;
life_delivery_temp = -1;

life_processing_temp = -1;
life_gathering_temp = -1;

life_copRep_temp = -1;
life_indepRep_temp = -1;
life_opforRep_temp = -1;

// Opfor
life_opforPickup_in_progress = false;

// Guild Framework
life_guild_changed = false;
...
life_session_completed_2 = false;
