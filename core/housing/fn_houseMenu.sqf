...
if (_curTarget isKindOf "House_F" && playerSide isEqualTo west) exitWith {
    ...
    private _vaultHouse = [[["Altis", "Land_Research_house_V1_F"], ["Tanoa", "Land_Medevac_house_V1_F"], ["Malden", "Land_ConcreteWall_01_l_gate_F"]]] call TON_fnc_terrainSort;
    private _altisArray = [16019.5,16952.9,0];
    private _tanoaArray = [11074.2,11501.5,0.00137329];
	  private _maldenArray = [7777.23,5861.75,10.3];
