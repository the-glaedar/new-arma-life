...
private _hideoutObjs = [[["Altis", _altisArray], ["Tanoa", _tanoaArray], ["Malden", _maldenArray]]] call TON_fnc_terrainSort;
...
if ((_hideout getVariable ["inCaptu re",false])) exitWith {hint localize "STR_GNOTF_onePersonAtATime";};
